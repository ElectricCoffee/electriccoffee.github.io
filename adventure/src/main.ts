...
import {Parser, Actions} from "./parser.js";
import {rooms, Room, Direction} from "../data/rooms.js";
...
const actions: Actions = {
    ...
    go:   x => {map.move(x[0] as Direction); reloadRoom()},
    move: x => {map.move(x[0] as Direction); reloadRoom()},
...
function readEvalPrint() {
    let input = inputbox != null ? inputbox.value : "";
